...
bash_extractor = BashOperator(
                            ...
                            bash_command="python /opt/airflow/dags/04_biella.py", # esegue __main__
                            dag=dag,
                            )
...
start_op >>[bash_extractor,python_extractor ] >> sensor_file >> python_transform  >> python_group >>last_op 
