...
dag = DAG(
    dag_id='ab_example_sqlite2',
    schedule_interval='@once',
    start_date=datetime(2021, 1, 1),
    tags=['iungo', 'sqlite'],
    catchup=False,
    template_searchpath='/opt/airflow/dags/input_files/'    ###
)
...
#file_path = os.getcwd() + os.sep + "dags" + os.sep + "input_files" + os.sep + 'create_table.sql'
...
create_table_sqlite_task >> external_create_table_sqlite_task >> insert_sqlite_hook() >> replace_sqlite_hook() #  external_create_table_sqlite_task        secondo posto e aggiungi template_searchpath in dag